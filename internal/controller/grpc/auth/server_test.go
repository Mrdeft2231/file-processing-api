...
func TestRegister(t *testing.T) {
	...
	mockAuth.On("Register", req.Username, req.Password).Return("123", nil)
...
func TestLogin(t *testing.T) {
	...
	mockAuth.On("Login", req.Username, req.Password).Return("access_token", "refresh_token", nil)
...
func TestLoginValidationError(t *testing.T) {
	...
	mockAuth.On("Login", req.Username, req.Password).Return("", "", errors.New("invalid credentials"))
