...
import (
	"context"
	pb "gitlab.crja72.ru/golang/2025/spring/course/projects/go21/auth-api/gen/auth"
	"gitlab.crja72.ru/golang/2025/spring/course/projects/go21/auth-api/internal/usecase/auth"
	"gitlab.crja72.ru/golang/2025/spring/course/projects/go21/auth-api/pkg/validator"
)
...
func (s *AuthServer) Register(ctx context.Context, req *pb.RegisterRequest) (*pb.RegisterResponse, error) {
	...
	userID, err := s.auth.Register(req.Username, req.Password)
	if err != nil {
		return nil, err
	}
...
func (s *AuthServer) Login(ctx context.Context, req *pb.LoginRequest) (*pb.LoginResponse, error) {
	...
	accessToken, refreshToken, err := s.auth.Login(req.Username, req.Password)
	if err != nil {
		return nil, err
	}
